...
const Project = () => {
    ...
    useEffect(() => {
        ...
        const targets = [
            document.getElementById("p6-overflow-hidden-1"),
            document.getElementById("p6-overflow-hidden-2"),
            document.getElementById("p6-overflow-hidden-3")
        ];
    ...
    <div className="w-full h-[70vh] relative top-1/2 transform -translate-y-1/2 overflow-hidden transition-shadow duration-300">
        <div className="project-2-wrapper bg-[#ee7ffa] w-full h-full p-1">
            <div className="project-2 bg-gray-800 w-full h-full overflow-hidden">
                <div id="p6-container" className="h-[calc(100%_-_50px)] w-full overflow-hidden">
                    ...
                    <div className="h-2/3 lg:h-1/2 p-2 pt-0 sm:pt-1 text-[#ee7ffa] flex flex-col justify-start">
                        ...
                        <div id="p6-overflow-hidden-3" className="flex flex-wrap items-center justify-between gap-2 pl-[50px] w-full h-fit mt-auto">
                            ...
                            <div className="flex flex-wrap items-center justify-end gap-2 h-full ml-auto">
                                <Image height={40} width={40} src="/Logos/Node.png" alt="Node.js" className="bg-white h-13 w-18 rounded-2xl object-contain" />
                                <Image height={40} width={40} src="/Logos/Mongo.webp" alt="MongoDB" className="bg-white h-13 w-18 rounded-2xl object-contain" />
                                <Image height={40} width={40} src="/Logos/express.png" alt="Express.js" className="bg-white h-13 w-18 rounded-2xl object-contain" />
                                <Image height={40} width={40} src="/Logos/ejs.png" alt="EJS" className="bg-white h-13 w-18 rounded-2xl object-contain" />
                            </div>
                        </div>
                    </div>
                </div>
